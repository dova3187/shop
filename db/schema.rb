...
ActiveRecord::Schema.define(version: 20161104160134) do
  ...
  create_table "spree_addresses", force: :cascade do |t|
    ...
    t.string   "high_street",       limit: 255
    t.string   "colony_name",       limit: 255
    t.string   "outside_number",    limit: 255
    t.string   "internal_number",   limit: 255
    t.boolean  "required_bill"
  ...
  create_table "spree_branches", force: :cascade do |t|
    t.string   "Br_Description",     limit: 255
    t.string   "Br_Company_Name",    limit: 255
    t.string   "Br_Enterprise",      limit: 255
    t.string   "Br_Email",           limit: 255
    t.string   "Br_Ext_Telephone",   limit: 255
    t.string   "Br_Local_Telephone", limit: 255
    t.string   "Br_Comment",         limit: 255
    t.boolean  "Br_status",                      default: true
    t.datetime "created_at"
    t.datetime "updated_at"
  end

  create_table "spree_branches_users", id: false, force: :cascade do |t|
    t.integer "branch_id", limit: 4
    t.integer "user_id",   limit: 4
  end

  add_index "spree_branches_users", ["branch_id"], name: "index_spree_branches_users_on_branch_id", using: :btree
  add_index "spree_branches_users", ["user_id"], name: "index_spree_branches_users_on_user_id", using: :btree
  ...
  create_table "spree_colonies", force: :cascade do |t|
    t.string   "description",      limit: 255
  ...
  create_table "spree_conekta", force: :cascade do |t|
    t.string  "conekta_id",              limit: 255
    t.string  "livemode",                limit: 255
    t.string  "created_at_from_conekta", limit: 255
    ...
    t.string  "fraud_score",             limit: 255
  end
  ...
  create_table "spree_customer_addresses", force: :cascade do |t|
    t.string   "title",           limit: 255
    t.integer  "user_id",         limit: 4
    t.integer  "state_id",        limit: 4
    t.integer  "city_id",         limit: 4
    t.integer  "colony_id",       limit: 4
    t.string   "high_street",     limit: 255
    t.string   "address1",        limit: 255
    t.string   "address2",        limit: 255
    t.string   "outside_number",  limit: 255
  ...
  add_index "spree_customer_addresses", ["city_id"], name: "index_spree_customer_addresses_on_city_id", using: :btree
  add_index "spree_customer_addresses", ["colony_id"], name: "index_spree_customer_addresses_on_colony_id", using: :btree
  add_index "spree_customer_addresses", ["state_id"], name: "index_spree_customer_addresses_on_state_id", using: :btree
  add_index "spree_customer_addresses", ["user_id"], name: "index_spree_customer_addresses_on_user_id", using: :btree
  ...
  create_table "spree_line_items", force: :cascade do |t|
    ...
    t.text     "line_item_comment",            limit: 255
  ...
  create_table "spree_orders", force: :cascade do |t|
    ...
    t.string   "branch_id",                    limit: 255,                            default: "0"
    t.boolean  "asignado",                                                            default: false
    t.boolean  "downloaded_order",                                                    default: false
    t.integer  "print_count",                  limit: 4,                              default: 0
    t.boolean  "printed_order",                                                       default: false
    t.string   "payment_method",               limit: 255
    t.boolean  "need_utensils",                                                       default: false
    t.decimal  "taxable_adjustment_total",                   precision: 10, scale: 2, default: 0.0,     null: false
    t.decimal  "non_taxable_adjustment_total",               precision: 10, scale: 2, default: 0.0,     null: false
  end
  ...
  create_table "spree_payments", force: :cascade do |t|
    ...
    t.decimal  "customer_payment_amount",                  precision: 10, scale: 2
    t.string   "conekta_token_id",             limit: 255
    t.string   "conekta_message_to_purchaser", limit: 255
    t.string   "conekta_error_code",           limit: 255
  end
  ...
  create_table "spree_status_users", force: :cascade do |t|
    t.string   "name",       limit: 255
    t.boolean  "status"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "spree_users", force: :cascade do |t|
    ...
    t.string   "Us_Name",                limit: 100
    t.string   "Us_Last_Name",           limit: 100
    t.string   "image",                  limit: 255
    t.string   "Us_Cell_Number",         limit: 15
    t.string   "Us_Phone_Number",        limit: 20
    t.integer  "Us_User_Removed",        limit: 4
    t.string   "Us_Comment_Removed",     limit: 255
    t.datetime "Cu_Date_Born"
    t.string   "Cu_gender",              limit: 20
    t.string   "Cu_Comment",             limit: 255
    t.integer  "status_users_id",        limit: 4,   default: 1
  end
  ...
  create_table "spree_variants", force: :cascade do |t|
    ...
    t.string   "mpro_product_id",   limit: 255
  end
